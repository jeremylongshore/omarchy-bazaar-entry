...
| REQ-BZ-002 | MUST | README.md | Filter by category and kind, rank by views per day since listing, and flag records without install commands | L3, L7 | tests/model.test.js, tests/mutation-contract.test.js | Covered |
